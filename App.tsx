  ...
  const renderHome = () => (
    <div className="space-y-8 md:space-y-16 animate-fade-in pb-24">
      <section>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] md:rounded-[3.5rem] p-6 md:p-14 border border-slate-200 dark:border-slate-800 shadow-xl relative overflow-hidden mb-12">
          ...
          <form onSubmit={handleSearch} className="flex bg-slate-100 dark:bg-slate-800 rounded-2xl border-2 border-slate-200 dark:border-slate-700 overflow-hidden max-w-md w-full">
            ...
            />
            <button type="submit" className="px-5 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-black uppercase text-[9px]">Atualizar</button>
          </form>
        </div>
